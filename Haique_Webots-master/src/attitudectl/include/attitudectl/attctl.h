...
class MPC_CTL{
    ...
    SX Dyna_Func(SX state, SX con, SX drag){
    ...
    void solve();
    void updatePara(double torque1, double torque2, double torque3);
    void getFirstCon();
    void updatex0(double phi_, double theta_, double psi_, double p_, double q_, double r_);
    void updatexs();
    ...
    vector<double> x0;
    vector<double> x0_Eular;
    vector<double> x0_Eular_dot;
    vector<double> xs;
    vector<double> x_dot;
    vector<double> para;
